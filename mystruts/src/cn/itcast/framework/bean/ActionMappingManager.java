...
public class ActionMappingManager {
	...
	public ActionMapping getActionMapping(String actionName) {
		if (actionName == null) {
			throw new RuntimeException("傳入參數有誤，請查看struts.xml配置的路徑。");
		}
		
		ActionMapping actionMapping = allActions.get(actionName);
		if (actionMapping == null) {
			throw new RuntimeException("該路徑 [" + actionName + "] 在  [struts.xml] 中找不到");
		}
	...
	private void init() {
		/********DOM4J读取配置文件***********/
System.err.println("ActionMappingManager = 讀取xml文件");
	...
	public String toString() {
		String str="ActionMappingManager::[\n"+
				"  " + allActions +
				"\n]";
		return str;
	}
